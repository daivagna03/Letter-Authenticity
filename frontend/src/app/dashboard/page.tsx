        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-8">
              ...
              {/* Analytics Section — Project Alpha inspired */}
              <div>
                <div className="flex justify-between items-end mb-4">
                  <div>
                    <h3 className="font-bold text-slate-900 text-lg">System Insights</h3>
                    <p className="text-xs text-slate-500 mt-0.5">Real-time overview of document generation velocity.</p>
                  </div>
                  <div className="text-right">
                    <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">CURRENT PERIOD</p>
                    <p className="text-xs font-bold text-slate-600">{currentPeriodStr}</p>
                  </div>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {/* Today Card */}
                  <div className="bg-[#f8fafc] rounded-xl p-7 border border-slate-100 flex flex-col justify-between h-44">
                ...
                {/* 30-Day Activity Bar */}
                <div className="bg-white rounded-xl p-6 border border-slate-100 mt-6">
                  <h4 className="font-bold text-slate-800 mb-1 text-sm">30-Day Activity</h4>
